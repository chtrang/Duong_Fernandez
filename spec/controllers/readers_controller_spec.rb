  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved reader as @reader" do
        post :create, {:reader => invalid_attributes}, valid_session
        expect(assigns(:reader)).to be_a_new(Reader)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested reader" do
        reader = Reader.create! valid_attributes
        put :update, {:id => reader.to_param, :reader => new_attributes}, valid_session
        reader.reload
    ...
    context "with invalid params" do
      it "assigns the reader as @reader" do
        reader = Reader.create! valid_attributes
        put :update, {:id => reader.to_param, :reader => invalid_attributes}, valid_session
        expect(assigns(:reader)).to eq(reader)
      end
